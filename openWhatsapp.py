...
if os.name == 'nt':  # Windows
    os.chdir('E:/oselox/Pycharm Projects/projects/Include/Driver')
    print(os.getcwd())
    path = os.getcwd()
elif os.name == 'posix':  # MACOSX
    print(os.getcwd)
    os.chdir('/Users/oselox/PycharmProjects/projects/Include/Driver')
    print(os.getcwd())
    path = os.getcwd()
else:  # Mainly Linux
    print(os.getcwd)
    os.chdir('/home/oselox/Pycharm Projects/projects/Include/Driver')
    print(os.getcwd())
    path = os.getcwd()
